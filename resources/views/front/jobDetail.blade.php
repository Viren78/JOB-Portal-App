                ...
                <div class="card shadow border-0">
                    <div class="job_details_header">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            ...
                            <div class="jobs_right">
                                <div class="apply_now">
                                    <a class="heart_mark {{ ($savedJobCount == 1) ? 'saved-job' : '' }}" href="javascript:void(0);" onclick="saveJob({{ $job->id }})"> <i class="fa fa-heart-o" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @else
                                <a href="javascript:void(0);" class="btn btn-secondary" disabled >Log in to Apply</a>
                            @endif
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-hover">
                                ...
                                @if ($applications->isNotEmpty())
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="tel:{{ $application->user->mobile }}">{{ $application->user->mobile }}</a></td>
