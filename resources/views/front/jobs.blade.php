                        ...
                        <div class="mb-4">
                            ...
                            @if ($jobType->isNotEmpty())
                                ...
                                <div class="form-check mb-2"> 
                                    <input {{ (in_array($job->id, $jobTypeArray)) ? 'checked': '' }} class="form-check-input " name="job_type" type="checkbox" value="{{ $job->id }}" id="job-type-{{ $job->id }}">    
                                    <label class="form-check-label " for="job-type-{{ $job->id }}">{{ $job->name }}</label>
                                </div>
                                @endforeach
                            @endif
                        </div>
                ...
                <div class="job_listing_area">                    
                    ...
                    <div class="row">
                        ...
                        @if ($categories->isNotEmpty())
                            ...
                            @else
                                <div class="text-center py-5 text-muted" style="height: 60vh;">No jobs found.</div>
                        @endif 
                            <div>
