        ...
        $('#editJobForm').submit(function(e){
            ...
            success: function (response) {
                ...
                if (response.status == true) {
                    ...
                    if(errors.category){
                        $('#category').toggleClass('is-invalid')
                                .siblings('p')
                    ...
                    if(errors.jobType){
                        $('#jobType').toggleClass('is-invalid')
                    ...
                    if(errors.vacancy){
                        $('#vacancy').toggleClass('is-invalid')
                                .siblings('p')
                                .addClass('invalid-feedback')
                                .html(errors.vacancy);
                    }else{
                    ...
                    if(errors.description){
                        $('#description').toggleClass('is-invalid')
                                .siblings('p')
                                .addClass('invalid-feedback')
                    ...
                    if(errors.experience){
                        $('#experience').toggleClass('is-invalid')
                                .siblings('p')
                                .addClass('invalid-feedback')
                    ...
                    if(errors.company_name){
                        $('#company_name').toggleClass('is-invalid')
                                .siblings('p')
                                .addClass('invalid-feedback')
