                                    ...
                                    @if ($applications->isNotEmpty())
                                        ...
                                        <tr class="active">
                                            <td>
                                                ...
                                                {{-- <div class="info1">{{ $application->count() }} Applicants</div> --}}
                                            </td>
                                            {{-- <td>{!! ($application->job->status == 1) ? '<p class="text-success">Active</p>' : '<p class="text-danger">Block</p>'  !!}</td> --}}
    ...
    <script>
        function deleteJobApplication(id){
            if (confirm('Are you sure you want to delete this user ?')){
                $.ajax({
                type: "delete",
                url: "{{ route('admin.jobApplication.destroy', $application->id) }}",
                data: {id:id},
                dataType: "json",
